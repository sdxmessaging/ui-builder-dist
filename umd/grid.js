(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('mithril'), require('mithril/stream'), require('jss'), require('@sdxmessaging/ui-widgets'), require('pusher-js'), require('js-sha256'), require('ag-grid-community')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'mithril', 'mithril/stream', 'jss', '@sdxmessaging/ui-widgets', 'pusher-js', 'js-sha256', 'ag-grid-community'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uiBuilder = {}, global._, global.m, global.m.stream, global.jss, global.uiWidgets, global.Pusher, global.sha256, global.agGrid));
}(this, (function (exports, lodash, m, stream, jss, uiWidgets, Pusher, jsSha256, agGridCommunity) { 'use strict';
  ...
  //const uiSheet: StyleSheet = jss.createStyleSheet({}).attach();
  ...
  function applyThemeUiWidgets() {
      ...
      uiWidgets.updateTheme({
          ...
          //TODO Applies the bss responsive class as btnBg - 
  ...
  var ActionCard = /** @class */ (function () {
      ...
      ActionCard.prototype.view = function (_a) {
          ...
          return m__default['default'](".flex.items-center.justify-center.w-100.overflow-hidden.ma3", {
          ...
          }, m__default['default'](".flex.w-100.h-100.pa2", m__default['default'](".flex.flex-column.h-100.mr4", { class: (overwrite === null || overwrite === void 0 ? void 0 : overwrite.uiActionCardInnerWrapper) + " " + theme().uiActionCardInnerWrapper }, m__default['default']('h4.w-100.flex-auto', {
              class: joinClasses([
              ...
              href: href,
              target: target
          }) : null), m__default['default'](".flex.justify-center.items-center", {
              class: joinClasses([
  ...
  /**
   * @deprecated For mapping passed notification streams into dialog state
   * Use dialog state directly
   */
  function bridgeNotification(notification) {
      notification.map(function (newNotification) {
          // Ignore notifications with empty message
          if (newNotification.message !== "") {
              dialog(newNotification);
          }
      });
  }
      ...
      SearchBox.prototype.view = function (_a) {
          ...
          return m__default['default']("form.flex.flex-row.items-center.bg-light-gray", {
              ...
              field: {
                  ...
                  label: "",
                  type: "search" /* search */,
                  classes: "bn pa2 bg-transparent " + b$1.hideInputClearButton.class,
  ...
  var CustomHeader = /** @class */ (function () {
      ...
      CustomHeader.prototype.render = function (text) {
          this.elem.className = theme().uiTableHeader + " truncate";
  ...
  var SingleGrid = /** @class */ (function () {
      ...
      SingleGrid.prototype.view = function () {
          return m__default['default'](".h-100.ag-theme-alpine" + b$1.agGrid, {
              class: theme().uiTable
          });
      };
  ...
  (function (GridType) {
      GridType[GridType["Single"] = 0] = "Single";
      GridType[GridType["Paging"] = 1] = "Paging";
      // TODO Toggle option
  })(exports.GridType || (exports.GridType = {}));
  function grid(appConf, _a) {
      var notification = _a.notification, _b = _a.fullScreen, fullScreen = _b === void 0 ? true : _b, _c = _a.type, type = _c === void 0 ? exports.GridType.Single : _c, filter = _a.filter, _d = _a.search, search = _d === void 0 ? filter : _d, columnDefs = _a.columnDefs, test = _a.test, load = _a.load, columnAutoResize = _a.columnAutoResize;
      if (notification) {
      ...
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](Layout, {
                  ...
                  subheader: m__default['default'](SearchBox, {
                      placeholder: "Search",
                      searchValue: search
                  }),
                  // Full size column prevents flex-auto from collapsing in Safari
                  content: m__default['default'](".relative.flex-auto" + b$1.safariBug, m__default['default'](".pa2.aspect-ratio--object", [
                      m__default['default'](type === exports.GridType.Single ? SingleGrid : PagingGrid, {
