...
import mithril__default, { ComponentTypes, CommonAttributes, Children, ClassComponent, CVnode, CVnodeDOM, RequestOptions, RouteOptions } from 'mithril';
