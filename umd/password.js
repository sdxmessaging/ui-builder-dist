  ...
  var PasswordPage = /** @class */ (function () {
      ...
      PasswordPage.prototype.view = function () {
          ...
          return m__default['default'](Layout, m__default['default'](Panel, {
              content: m__default['default']("form.flex-auto.overflow-x-hidden.overflow-y-auto.mh3.safari-bug[method=post]", {
                  ...
                  m__default['default'](uiWidgets.PasswordInput, {
                      field: {
                          ...
                          instant: true,
                          uiClass: {
                              wrapper: joinClasses([theme().uiInputFieldset, "pa2"]),
                              inputWrapper: joinClasses(["mb2 bb b--black-20", theme().uiLoginInputWrapper, theme().uiInputWrapper]),
                              input: joinClasses([theme().uiInput]),
                              label: joinClasses([theme().uiInputLabel]),
                          },
                      },
