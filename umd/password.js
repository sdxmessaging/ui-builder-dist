(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('mithril'), require('mithril/stream'), require('jss'), require('@sdxmessaging/ui-widgets'), require('pusher-js'), require('js-sha256')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'mithril', 'mithril/stream', 'jss', '@sdxmessaging/ui-widgets', 'pusher-js', 'js-sha256'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uiBuilder = {}, global._, global.m, global.m.stream, global.jss, global.uiWidgets, global.Pusher, global.sha256));
}(this, (function (exports, lodash, m, stream, jss, uiWidgets, Pusher, jsSha256) { 'use strict';
  ...
  /** Apply IPasswordConfig rules to a given stream */
  function passValid(input, _a) {
      var minLen = _a.minLen, regex = _a.regex;
      return input.map(function (current) {
          return current.length === 0 || (current.length >= minLen && regex.test(current));
      });
  }
  /** Input has length and pass is true */
  function formValid(input, pass) {
      return stream__default['default'].lift(function (value, valid) { return value.length > 0 && valid; }, input, pass);
  }
  var PasswordPage = /** @class */ (function () {
      function PasswordPage() {
          this.passwordText = stream__default['default']("");
          this.passwordValid = stream__default['default']();
          this.formValid = stream__default['default']();
      }
      PasswordPage.prototype.oninit = function (_a) {
          var passwordConfig = _a.attrs.passwordConfig;
          this.passwordValid = passValid(this.passwordText, passwordConfig);
          this.formValid = formValid(this.passwordText, this.passwordValid);
      };
      PasswordPage.prototype.view = function () {
          var auth = application().auth;
          if (!auth) {
              return m__default['default']("span", "No authentication set");
          }
          var passResetPath = auth.passResetPath;
          return m__default['default'](Layout, m__default['default'](Panel, {
              content: m__default['default']("form.flex-auto.overflow-x-hidden.overflow-y-auto.mh3[method=post]" + b$1.safariBug, {
                  action: passResetPath
              }, [
                  m__default['default']("p", "Please enter (and confirm) your new password - at least four characters in length and must match - then click RESET PASSWORD."),
                  m__default['default']("p", "Note that this facility is available for one hour from your initial request."),
                  m__default['default'](uiWidgets.PasswordInput, {
                      field: {
                          id: "password",
                          label: "New Password",
                          type: "password",
                          ...
                          instant: true,
                          classes: "pa2",
                          containerClass: "mb2 bb b--black-20"
                      },
                      value: this.passwordText
                  }),
                  m__default['default'](".flex.flex-row.mb3", m__default['default']("span.dark-red.f7", {
                      class: this.passwordValid() ? "dn" : ""
                  }, "Password should be more than four characters"), m__default['default'](uiWidgets.Button, {
  ...
  function password(appConf, config) {
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](PasswordPage, {
