(function (global, factory) {
   ...
   */
  function extractFields(item, fieldList) {
      if (item.modelId === "category") {
          return item.label;
      }
  ...
  */
  ...
  var CustomPanel = /** @class */ (function () {
      ...
      CustomPanel.prototype.view = function (_a) {
          ...
          return m__default['default'](Panel, {
              ...
              content: m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto" + b$1.safariBug, component
  ...
  var Icon = /** @class */ (function () {
      ...
      Icon.prototype.view = function (_a) {
          ...
          return typeof icon === "string" ? m__default['default']("i.fal.fa-fw.w2.mr2.tc" + b$1.shrink0, {
              class: icon
  ...
  var ItemEdit = /** @class */ (function () {
      ...
      ItemEdit.prototype.view = function (_a) {
          ...
          return m__default['default'](Panel, {
              ...
              content: m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto.pa2" + b$1.safariBug, [
  ...
  //import { selectItem } from "../../routeUtils";
  //import { Icon } from "../icon";
  //import { Button } from "@sdxmessaging/ui-widgets";
  var BaseItem = /** @class */ (function () {
      ...
      BaseItem.prototype.view = function (_a) {
          ...
          return m__default['default']("div", {
              ...
              m__default['default']("div.justify-between", {
                  class: theme().uiItemRowContent,
                  onclick: function () { return lodash__default['default'].isArray(model.action) ? null : selectItem(model, item); }
              }, [
                  icon ?
                      typeof icon === "string" ?
                  ...
                  this.subheading ?
                      ...
                      : null,
                  lodash__default['default'].isArray(model.action) ?
                      m__default['default']("div", {
                          class: theme().uiItemButtonsWrapper
                      }, lodash__default['default'].map(model.action, function (data) {
                          return m__default['default'](uiWidgets.Button, {
                              label: data.label,
                              classes: data.classes + " " + theme().uiItemActionButton,
                              icon: data.icon,
                              onclick: function () { return actionItem(item, data.action); }
                          });
                      })) : null
              ])
          ]);
      ...
      BaseItem.prototype.heading = function (_a) {
          ...
          return m__default['default']("span.ws-normal.mb1", extractFields(item, model.heading));
      };
      BaseItem.prototype.subheading = function (_a) {
          var model = _a.model, item = _a.item;
          var subheading = extractFields(item, model.subheading);
          return subheading
              ? m__default['default']("span.f6.ws-normal.silver", subheading)
              : null;
      };
      BaseItem.prototype.postItem = function (_) {
          return null;
      };
      return BaseItem;
  }());
      ...
      CategoryItem.prototype.view = function (_a) {
          ...
          return hideEmpty && this.itemCount() === 0
              ...
              : m__default['default'](".flex.items-center.justify-between.ma2.pv2.bb.b--black-20.dim.pointer", {
                  ...
                  this.itemCount() ? m__default['default'](".silver" + b$1.shrink0, [
                      type === "single" /* single */
                      ...
                      m__default['default']("i.fal.fa-fw.fa-chevron-right.mh2" + b$1.shrink0)
                  ]) : null
              ]);
      };
      return CategoryItem;
  ...
  var FileItem = /** @class */ (function (_super) {
      ...
      FileItem.prototype.subheading = function (attrs) {
          ...
          return [
              ...
              lodash__default['default'].map(item.files, function (fileObj) { return m__default['default'](".flex.flex-wrap.nt1.nr1.nb1.nl1.f6.ws-normal.silver", _this.fileProperties(fileObj, model)); })
          ];
      };
      FileItem.prototype.postItem = function (_a) {
          var item = _a.item;
          var actionList = item.actions || [];
          return m__default['default'](".flex.flex-wrap.items-center.justify-end.pl2.nl1.nr1" + b$1.shrink0, lodash__default['default'].map(actionList, function (_a) {
              var _id = _a._id, type = _a.type, label = _a.label;
              return m__default['default'](uiWidgets.Button, {
                  classes: "ma1",
                  label: label,
                  onclick: function () { return actionItem(item, type, _id); }
              });
          }));
      };
  ...
  var LinkItem = /** @class */ (function (_super) {
      ...
      LinkItem.prototype.subheading = function (attrs) {
          ...
          return [
              _super.prototype.subheading.call(this, attrs),
              m__default['default'](".flex.flex-wrap.nt1.nb1.mr2.pr4.f6.ws-normal", lodash__default['default'].map(linkList, function (link) {
                  var props = item.props;
                  ...
                  if (field && linkVal) {
                      ...
                      return m__default['default'](".ma1.w-100.w-third-l", {
      ...
      switch (sortConf.type) {
          case "heading" /* heading */:
              return itemList.map(function (list) { return lodash__default['default'].sortBy(list, function (item) {
                  ...
                  return model ? extractFields(item, model.heading) : "";
              }); });
          case "props" /* props */: {
              var _a = sortConf.props, props_1 = _a === void 0 ? [] : _a, desc_1 = sortConf.desc;
              return itemList.map(function (list) {
                  var orderList = lodash__default['default'].sortBy(list, function (item) { return extractFields(item, props_1); });
          ...
          case "rolodex" /* rolodex */:
              return itemList.map(function (list) {
                  return groupMapToList(lodash__default['default'].groupBy(list, function (item) {
                      var model = modelMap[item.modelId];
                      return model ? lodash__default['default'].head(String(extractFields(item, model.heading))) : "N/A";
                  }));
              });
          case "tags" /* tags */: {
              var ctx_1 = order.ctx;
  ...
  var ItemList = /** @class */ (function () {
      ...
      ItemList.prototype.oninit = function (_a) {
          ...
          this.filteredItems = stream__default['default'].lift(function (sortedList, search) {
              return lodash__default['default'].filter(sortedList, function (item) {
                  ...
                  return model ? search.test(String(extractFields(item, model.search))) : false;
              });
      ...
      ItemList.prototype.view = function (vnode) {
          var _this = this;
          var _a = vnode.attrs.item, label = _a.label, _b = _a.search, search = _b === void 0 ? true : _b, pre = _a.pre, post = _a.post;
          return m__default['default'](Panel, {
              header: [
              ...
              content: m__default['default']("div" + b$1.safariBug, {
  ...
  var ItemCard = /** @class */ (function () {
      ...
      ItemCard.prototype.oninit = function (_a) {
          var _b = _a.attrs, item = _b.item, itemList = _b.itemList;
          this.isCategory = item.modelId === "category";
          if (this.isCategory) {
              var _c = item, content = _c.content, _d = _c.countContent, countContent_1 = _d === void 0 ? content : _d, contentAll_1 = _c.contentAll;
      ...
      ItemCard.prototype.view = function (_a) {
          var _b = _a.attrs, model = _b.model, item = _b.item;
          var heading = this.isCategory ? item.label : extractFields(item, model.heading);
          var subheading = this.isCategory ? item.subheading : extractFields(item, model.subheading);
          var icon = this.isCategory ? item.icon : model.icon;
          var hideEmpty = this.isCategory ? item.hideEmpty : false;
          return hideEmpty && this.itemCount() === 0
              ? null
              : m__default['default']("div.relative.pa2.ma3.f7.f6-ns.f5-l.pointer" + b$1.shrink0, {
                  tabIndex: 0,
                  ariaLabel: heading,
                  title: heading,
                  style: item.style,
                  ...
                  m__default['default'](".flex.flex-column.items-center.h-100.w-100.overflow-hidden", {}, m__default['default']("span" + b$1.shrink0, {
                      ...
                      ? m__default['default']("i" + b$1.shrink0, {
                      ...
                      : m__default['default']("img", {
                          ...
                          height: icon.height,
                          width: icon.width
                      }), subheading ? m__default['default']("span" + b$1.shrink0, {
  ...
  var propMap$1 = (_a$2 = {},
      ...
      _a$2);
  var fileMap$1 = (_b$2 = {},
      _b$2["fileMulti" /* fileMulti */] = uiWidgets.FileList,
      _b$2["file" /* file */] = uiWidgets.FileList,
      _b$2["imageMulti" /* imageMulti */] = uiWidgets.ImageList,
      _b$2["image" /* image */] = uiWidgets.ImagePreview,
      _b$2["sign" /* sign */] = uiWidgets.ImagePreview,
      _b$2);
          ...
          return m__default['default'](Panel, {
              ...
              content: m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto.pa2" + b$1.safariBug, [
                  m__default['default'](".pv2.flex.flex-row.bb.b--black-20", [
                      m__default['default'](Icon, { icon: model.icon }),
                      m__default['default']("span.truncate", extractFields(item, model.heading))
                  ]),
                  // Present widgets
  ...
  var PageOverlay = /** @class */ (function () {
      ...
      PageOverlay.prototype.view = function (_a) {
          ...
          return m__default['default'](".relative" + b$1.docOverlay, lodash__default['default'].map(overlay, function (field) {
              ...
              return m__default['default'](".absolute", {
                  ...
                  label: "",
                  readonly: true,
                  classes: classes + " " + (interactive ? theme().uiPdfFieldOverlay : b$1.arrow.class)
              }));
          }));
      };
      return PageOverlay;
  ...
  var PageManager = /** @class */ (function () {
      ...
      PageManager.prototype.view = function (_a) {
          ...
          return m__default['default'](".flex-auto.overflow-x-auto.overflow-y-scroll.bg-gray" + b$1.safariBug, {
              onclick: function (_a) {
  ...
  var Pdf = /** @class */ (function () {
      ...
      Pdf.prototype.view = function () {
          ...
          return m__default['default'](Panel, {
              header: [
                  noreturn() ? m__default['default']("div") : m__default['default'](uiWidgets.NavButton, {
                      icon: "far fa-arrow-left nl2",
                      title: "Back",
                      classes: "f2 dim",
                      onclick: back
                  }),
                  m__default['default'](uiWidgets.NavButton, {
                      icon: "far fa-search-plus fa-fw",
                      title: "Zoom In",
                      classes: "f2 dim",
                  ...
                  m__default['default'](uiWidgets.NavButton, {
                      icon: "far fa-redo fa-fw",
                      title: "Reset Zoom",
                      classes: "f2 dim",
                      onclick: function () { return _this.resetZoom(); }
                  }),
                  m__default['default'](uiWidgets.NavButton, {
                      icon: "far fa-search-minus fa-fw",
                      title: "Zoom Out",
                      classes: "f2 dim",
              ...
              content: this.pdf
                  ...
                  : m__default['default'](".flex-auto.bg-light-gray", m__default['default']("span.ma3.db.truncate" + b$1.subheading, this.statusText)),
              // Bottom toolbar area
              // TODO Consider moving out into own component
              footer: this.state() !== 0 /* view */ ? m__default['default'](".relative.flex.flex-column.justify-around.items-center.pa1.shadow-2" + b$1.shrink0, {
                  ...
                  m__default['default'](uiWidgets.NavButton, {
                      ...
                      classes: "absolute f1 top-0 nt4 br-100 shadow-4 pt3 " + b$1.button.bgButton.pulse.class,
