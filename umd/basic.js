(function (global, factory) {
  ...
  function basic(appConf, _a) {
      var toastMessage = _a.toastMessage, _b = _a.title, title = _b === void 0 ? "UNTITLED" : _b, _c = _a.lines, lines = _c === void 0 ? [] : _c, returnBtn = _a.returnBtn;
      if (toastMessage) {
          dialog(toastMessage);
      }
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](Layout, m__default['default'](Panel, {
                  content: m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto" + b$1.safariBug, [
                      m__default['default'](".ph4", [
                          ...
                          returnBtn && application.auth ? buildComponent({
                              type: "basic",
                              data: {
                                  href: application.auth.loginPath,
                                  text: "RETURN TO LOGIN"
                              }
                          }) : null
                      ]),
                      // Company footer
                      application.footer ? buildComponent(application.footer) : null
                  ])
              })); }
          });
          return {
