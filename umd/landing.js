  ...
  var LandingPage = /** @class */ (function () {
      ...
      LandingPage.prototype.view = function (_a) {
          ...
          return m__default['default'](Layout, m__default['default'](Panel, {
              content: landing ? m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto.pa2.safari-bug", [
                  ...
                  m__default['default']("form", {
                      ...
                      m__default['default'](uiWidgets.BaseInput, {
                          field: {
                              ...
                              uiClass: {
                                  wrapper: joinClasses([theme().uiInputFieldset]),
                                  inputWrapper: joinClasses(["mb2 bb b--black-20", theme().uiInputWrapper]),
                                  input: joinClasses([theme().uiInput]),
                                  label: joinClasses([theme().uiInputLabel]),
                              },
                          },
                      ...
                      m__default['default'](uiWidgets.Button, {
                          label: "Next",
                          type: "submit",
                          icon: "fal fa-sign-in-alt fa-2x db center mb2",
