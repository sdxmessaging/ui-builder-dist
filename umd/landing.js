(function (global, factory) {
  ...
  var LandingPage = /** @class */ (function () {
      function LandingPage() {
          this.username = stream__default['default']("");
      }
      LandingPage.prototype.view = function (_a) {
          var _this = this;
          var onNext = _a.attrs.onNext;
          var auth = application().auth;
          if (!auth) {
              return m__default['default']("span", "No authentication set");
          }
          var title = auth.title, landing = auth.landing;
          return m__default['default'](Layout, m__default['default'](Panel, {
              content: landing ? m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto.pa2" + b$1.safariBug, [
                  m__default['default'](".mb2.fw7", title),
                  lodash__default['default'].map(landing.lines, function (line) { return m__default['default']("p", line); }),
                  // Username input form
                  m__default['default']("form", {
                      onsubmit: function () {
                          onNext(_this.username());
                          return false;
                      }
                  }, [
                      m__default['default'](uiWidgets.BaseInput, {
                      ...
                      m__default['default'](uiWidgets.Button, {
                          label: "Next",
                          type: "submit",
                          icon: "fa-2x fa-sign-in-alt db center mb2",
                          classes: "w-100 mb3 tc br4",
  ...
  function landing(appConf, toastMessage) {
      ...
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](LandingPage, {
                  onNext: function (identifier) {
                      if (!application.auth || !application.auth.landing) {
                          return;
                      }
                      m.request({
                          url: application.auth.landing.endpoint,
                          params: {
                              username: jsSha256.sha256(identifier)
                          }
                      }).then(redirect).catch(function (_a) {
                          var code = _a.code, message = _a.message;
                          if (code === 404) {
                              dialog({
                                  message: "Account not found",
                                  context: exports.ToastContext.warn,
                                  duration: 20000
                              });
                          }
                          else {
