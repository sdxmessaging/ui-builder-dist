(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('mithril'), require('mithril/stream'), require('jss'), require('@sdxmessaging/ui-widgets'), require('pusher-js'), require('js-sha256'), require('ag-grid-community'), require('pdf-lib'), require('pdfjs-dist')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'mithril', 'mithril/stream', 'jss', '@sdxmessaging/ui-widgets', 'pusher-js', 'js-sha256', 'ag-grid-community', 'pdf-lib', 'pdfjs-dist'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uiBuilder = {}, global._, global.m, global.m.stream, global.jss, global.uiWidgets, global.Pusher, global.sha256, global.agGrid, global.PDFLib, global.pdfjsLib));
}(this, (function (exports, lodash, m, stream, jss, uiWidgets, Pusher, jsSha256, agGridCommunity, pdfLib, pdfjsDist) { 'use strict';
  ...
  var CustomHeader = /** @class */ (function () {
      ...
      CustomHeader.prototype.init = function (_a) {
      ...
      CustomHeader.prototype.refresh = function (_a) {
          var displayName = _a.displayName;
          this.render(displayName);
          return true;
      };
      CustomHeader.prototype.render = function (text) {
          this.elem.className = "truncate";
          this.elem.textContent = text;
      };
      return CustomHeader;
  }());

  var SingleGrid = /** @class */ (function () {
      function SingleGrid() {
          this.gridOptions = {
              components: {
      ...
      SingleGrid.prototype.oncreate = function (_a) {
          var _this = this;
          var _b;
          var dom = _a.dom, _c = _a.attrs, columnDefs = _c.columnDefs, filter = _c.filter, test = _c.test, load = _c.load, columnAutoResize = _c.columnAutoResize;
          this.gridOptions.columnDefs = columnDefs;
          this.gridOptions.context = filter();
          // Support basic text filter
          this.gridOptions.isExternalFilterPresent = function () { return filter().length > 0; };
          this.gridOptions.doesExternalFilterPass = test;
          this.gridOptions.rowClass = theme().uiTableRow;
          new agGridCommunity.Grid(dom, this.gridOptions);
          if (columnAutoResize) {
              this.gridOptions.onGridSizeChanged = function () { var _a; return (_a = _this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.sizeColumnsToFit(); };
              (_b = this.gridOptions.api) === null || _b === void 0 ? void 0 : _b.sizeColumnsToFit();
          }
          // Load SingleGrid dataset
          this.showLoading();
          load({ offset: 0, limit: -1 }).then(function (rowData) {
              var _a;
              _this.hideLoading();
              (_a = _this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.setRowData(rowData);
          });
      };
      SingleGrid.prototype.onupdate = function (_a) {
          var filter = _a.attrs.filter;
          if (this.gridOptions.context === filter()) {
              return;
          }
          this.gridOptions.context = filter();
      ...
      SingleGrid.prototype.onremove = function () {
          var _a;
          (_a = this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.destroy();
      };
      SingleGrid.prototype.view = function () {
          return m__default['default'](".h-100.ag-theme-alpine", {
              class: joinClasses([theme().uiTable])
          });
      };
      SingleGrid.prototype.showLoading = function () {
          var _a;
          (_a = this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.showLoadingOverlay();
      };
      SingleGrid.prototype.hideLoading = function () {
          var _a;
          (_a = this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.hideOverlay();
      };
      return SingleGrid;
  }());
  ...
  function getDataSource(load, showLoading, hideLoading) {
      return {
          getRows: function (_a) {
              var startRow = _a.startRow, endRow = _a.endRow, successCallback = _a.successCallback, failCallback = _a.failCallback;
              var limit = endRow - startRow;
              showLoading();
  ...
  var PagingGrid = /** @class */ (function (_super) {
      __extends(PagingGrid, _super);
      function PagingGrid() {
      ...
      PagingGrid.prototype.oncreate = function (_a) {
          var _this = this;
          var _b;
          var dom = _a.dom, _c = _a.attrs, columnDefs = _c.columnDefs, filter = _c.filter, load = _c.load, columnAutoResize = _c.columnAutoResize;
          this.gridOptions.columnDefs = columnDefs;
          this.gridOptions.context = filter();
          this.gridOptions.datasource = getDataSource(load, lodash__default['default'].bind(this.showLoading, this), lodash__default['default'].bind(this.hideLoading, this));
          this.gridOptions.rowClass = theme().uiTableRow;
          new agGridCommunity.Grid(dom, this.gridOptions);
          if (columnAutoResize) {
              this.gridOptions.onGridSizeChanged = function () { var _a; return (_a = _this.gridOptions.api) === null || _a === void 0 ? void 0 : _a.sizeColumnsToFit(); };
  ...
  var PdfBuilder = /** @class */ (function () {
      ...
      PdfBuilder.prototype.init = function (font) {
              ...
              return __generator(this, function (_c) {
                  switch (_c.label) {
                      ...
                      case 1:
                          _a.pdf = _c.sent();
                          _b = this;
                          return [4 /*yield*/, this.pdf.embedFont(font)];
                      case 2:
                          _b.font = _c.sent();
                          return [2 /*return*/];
                  }
      ...
      PdfBuilder.prototype.pageCount = function () {
          return this.pdf.getPageCount();
      };
      PdfBuilder.prototype.sizePage = function (page) {
          page.setSize(this.pageSize[0], this.pageSize[1]);
      };
      PdfBuilder.prototype.addTextPage = function (text) {
          var page = this.pdf.addPage();
          this.sizePage(page);
      ...
      PdfBuilder.prototype.addFiles = function (fileArray) {
          return __awaiter(this, void 0, void 0, function () {
              var _i, fileArray_1, file;
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          ...
                          _a.label = 1;
                      case 1:
                          if (!(_i < fileArray_1.length)) return [3 /*break*/, 7];
                          file = fileArray_1[_i];
                          if (!(file.type === "application/pdf")) return [3 /*break*/, 3];
                          return [4 /*yield*/, this.addPdf(file)];
                      case 2:
                          _a.sent();
                          _a.label = 3;
                      case 3:
                          if (!(["image/png", "image/jpeg"].indexOf(file.type) !== -1)) return [3 /*break*/, 5];
                          return [4 /*yield*/, this.addImage(file)];
                      case 4:
                          _a.sent();
                          _a.label = 5;
                      case 5:
                          if (["image/png", "image/jpeg", "application/pdf"].indexOf(file.type) !== -1) {
                              console.warn("Unsupported file type of " + file.type);
                          }
                          _a.label = 6;
                      case 6:
                          _i++;
      ...
      PdfBuilder.prototype.fileToUint8Array = function (file) {
          return __awaiter(this, void 0, void 0, function () {
              var reader;
              return __generator(this, function (_a) {
                  switch (_a.label) {
      ...
      PdfBuilder.prototype.addPdf = function (pdf) {
          return __awaiter(this, void 0, void 0, function () {
              var pdfUint, pdfBytes, _i, _a, page, embed, newPage;
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      case 0: return [4 /*yield*/, this.fileToUint8Array(pdf)];
                      case 1:
                          pdfUint = _b.sent();
                          return [4 /*yield*/, pdfLib.PDFDocument.load(pdfUint)];
                      case 2:
                          pdfBytes = _b.sent();
                          _i = 0, _a = pdfBytes.getPages();
                          _b.label = 3;
                      case 3:
                          if (!(_i < _a.length)) return [3 /*break*/, 8];
                          page = _a[_i];
                          return [4 /*yield*/, this.pdf.embedPage(page)];
                      case 4:
                          embed = _b.sent();
                          return [4 /*yield*/, this.pdf.addPage([this.pageSize[0], this.pageSize[1]])];
                      case 5:
                          newPage = _b.sent();
                          return [4 /*yield*/, newPage.drawPage(embed, { height: this.pageSize[1], width: this.pageSize[0] })];
                      case 6:
                          _b.sent();
                          _b.label = 7;
                      case 7:
      ...
      PdfBuilder.prototype.addImage = function (image) {
          return __awaiter(this, void 0, void 0, function () {
              var imageBytes, embed, _a, _b, width, height, newPage;
              return __generator(this, function (_c) {
                  switch (_c.label) {
                      case 0: return [4 /*yield*/, this.fileToUint8Array(image)];
                      case 1:
                          imageBytes = _c.sent();
                          if (!(image.type === "image/jpeg")) return [3 /*break*/, 3];
                          return [4 /*yield*/, this.pdf.embedJpg(imageBytes)];
                      case 2:
                          _a = _c.sent();
                          return [3 /*break*/, 5];
                      case 3: return [4 /*yield*/, this.pdf.embedPng(imageBytes)];
                      case 4:
                          _a = _c.sent();
                          _c.label = 5;
                      case 5:
                          embed = _a;
                          _b = embed.scaleToFit(this.pageSize[0], this.pageSize[1]), width = _b.width, height = _b.height;
                          return [4 /*yield*/, this.pdf.addPage()];
                      case 6:
                          newPage = _c.sent();
                          this.sizePage(newPage);
                          return [4 /*yield*/, newPage.drawImage(embed, { x: 0, y: this.pageSize[1] - height, width: width, height: height })];
                      case 7:
                          _c.sent();
                          return [2 /*return*/];
                  }
      ...
      PdfBuilder.prototype.toBase64 = function () {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  return [2 /*return*/, this.pdf.saveAsBase64({ dataUri: true })];
              });
          });
      };
      PdfBuilder.prototype.toFile = function () {
          return __awaiter(this, void 0, void 0, function () {
              var base64, file;
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0: return [4 /*yield*/, this.toBase64()];
                      case 1:
                          base64 = _a.sent();
                          file = new File([
      ...
      // TODO Savelocal?
      PdfBuilder.prototype.toUint8Array = function () {
          return this.pdf.save();
      };
      return PdfBuilder;
  }());
  function pdfBuilderFactory(font) {
      if (font === void 0) { font = pdfLib.StandardFonts.Helvetica; }
      return __awaiter(this, void 0, void 0, function () {
          var builder;
          return __generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      ...
                      return [4 /*yield*/, builder.init(font)];
                  case 1:
                      _a.sent();
  ...
  function custom(appConf, _a) {
      var fullScreen = _a.fullScreen, responsiveHeader = _a.responsiveHeader, responsiveFooter = _a.responsiveFooter, logout = _a.logout, _b = _a.wrapContent, wrapContent = _b === void 0 ? true : _b, customAttrs = _a.customAttrs, header = _a.header, central = _a.central, footer = _a.footer;
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](Layout, {
                  fullScreen: fullScreen,
                  responsiveHeader: responsiveHeader,
                  responsiveFooter: responsiveFooter,
                  logout: logout,
                  header: header ? m__default['default'](header, attrs) : undefined,
                  footer: footer ? m__default['default'](footer, attrs) : undefined
              }, m__default['default'](Panel, {
                  content: wrapContent
                      ? m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto.safari-bug", m__default['default'](central, attrs))
                      : m__default['default'](central, attrs),
              })); }
          });
          return {
              application: application,
