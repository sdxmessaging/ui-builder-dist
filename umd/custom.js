(function (global, factory) {
  ...
  function custom(appConf, _a) {
      var notification = _a.notification, fullScreen = _a.fullScreen, responsiveHeader = _a.responsiveHeader, responsiveFooter = _a.responsiveFooter, logout = _a.logout, _b = _a.wrapContent, wrapContent = _b === void 0 ? true : _b, customAttrs = _a.customAttrs, header = _a.header, central = _a.central, footer = _a.footer;
      if (notification) {
      ...
      return bootstrap(appConf).then(function (_a) {
          ...
          m__default['default'].mount(document.getElementById("page"), {
              view: function () { return m__default['default'](Layout, {
                  ...
                  content: wrapContent
                      ? m__default['default'](".flex-auto.overflow-x-hidden.overflow-y-auto" + b$1.safariBug, m__default['default'](central, attrs))
